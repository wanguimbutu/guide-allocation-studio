...
export function PlannerGrid() {
  ...
  const handleAddDay = (taskName: string, dayIso: string, slot: Slot, anchor: { x: number; y: number }) => {
    ...
    if (!task) return;
    setPickerTarget({ dayIso, slot, anchor, presetCustomer: task.customerName, insertAfterTaskName: taskName });
  };
        ...
        <ActivityPicker
          ...
          onPick={(activityName, customerName) => {
            void addTask(
              ...
              pickerTarget.insertAfterTaskName
            );
